...
<body>
    ...
    <div class="container">
        ...
        <form action="write/write_action.php" method="post">
            ...
            <div class="form-group">
                <textarea id="ir1" class="form-control" name="content" rows="15" placeholder="내용을 입력하세요" required></textarea>
            ...
            <button type="submit" onclick="submitContents(this)" class="btn btn-success">게시글 올리기</button>
